...
| getTimeStart | donne l'heure de début de l'événement choisi | - en 1ère ligne : mettre le titre de l'événenement à rechercher, le texte doit être exact ; +
soit [yellow-background]#title=xxx#, exemple : title=Volet RDC +
- en 2nde ligne, il est possible de préciser un format de retour pour la date ; comme dans tout le reste au niveau de jeedom, les possibilités de format sont équivalents à ceux de php. +
...
| getTimeEnd | donne l'heure de fin de l'événement choisi | - en 1ère ligne : mettre le titre de l'événenement à rechercher, le texte doit être exact ; +
soit [yellow-background]#title=xxx#, exemple : title=Volet RDC +
- en 2nde ligne, il est possible de préciser un format de retour pour la date ; comme dans tout le reste au niveau de jeedom, les possibilités de format sont équivalents à ceux de php. +
soit [yellow-background]#date=xxx#, exemple : date=H:i:s ou date=d/m H:i +
*Remarque:* Si cette 2nde ligne n'est pas renseignée, la valeur retournée est au format timestamp.
| getUid | donne l'id technique de l'événement choisi | - en 1ère ligne : mettre le titre de l'événenement à rechercher, le texte doit être exact ; +
soit [yellow-background]#title=xxx#, exemple : title=Volet RDC
| getTitle | donne le titre de l'événement choisi en fonction d'un id | - en 1ère ligne : mettre l'id (uid) de l'événenement à rechercher, le texte doit être exact ; +
soit [yellow-background]#uid=xxx#, exemple : uid=23424houi877sdf@google.com
| getLocation | donne le lieu de l'événement choisi en fonction d'un id ou d'un titre | - en 1ère ligne : mettre le titre de l'événenement à rechercher, le texte doit être exact ; +
soit [yellow-background]#title=xxx#, exemple : title=Volet RDC +
